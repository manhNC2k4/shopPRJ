                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <div class="card">
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">List Orders Shipping</h6>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table align-items-center table-flush">
                                            ...
                                            <tbody>
                                                <c:forEach var="j" items="${requestScope.listOrderShipping}">
                                                    <tr>
                                                        <td>${j.orderId}</td>
                                                        <td>${j.userId}</td>
                                                        <td>
                                                        ...
                                                        <td><a href="shippingToDelivered?id=${j.orderId}" class="btn btn-sm btn-info">Delivered ?</a>
