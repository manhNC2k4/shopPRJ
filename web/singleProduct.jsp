<%-- 
    ...
    Created on : Jun 28, 2024, 9:53:34 PM
    Author     : LNV
--%>
                        ...
                        <div class="row">
                            <c:forEach var="image" items="${product.images}">
                                <div class="col-lg-6" style="padding: 0">
                                    <a href="${image}" class="image-popup prod-img-bg">
                                        <img src="${image}" alt="Product Image" style="
                    ...
                    <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="input-group col-md-6 d-flex mb-3">
                                ...
                                <input type="text" id="quantity" name="quantity" class="quantity form-control input-number" value="1" min="1" max="">
                    ...
                    <div class="col-md-12 tab-wrap">
                        ...
                        <div class="tab-content bg-light" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-day-2-tab">
                                <div class="p-4">
                                    <h3 class="mb-4">Manufactured By MayJa</h3>
