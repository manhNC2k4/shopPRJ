<%-- 
    Document   : index
    Created on : Jun 12, 2024, 8:40:04 PM
    Author     : LNV
--%>
...
<html lang="en">
    ...
    <body class="goto-here">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            <div class="container">
                <a class="navbar-brand" href="index.jsp">MayJaShop</a>
                                    ...
                                    <div class="product d-flex flex-column">
                                        ...
                                        <div class="text py-3 pb-4 px-3">
                                            ...
                                            <p class="bottom-area d-flex px-3">
                                                ...
                                                <a href="product-single.html" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
